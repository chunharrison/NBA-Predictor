...
def valid(epi: 'Episode') -> bool:
    return epi.series is not None and epi.season is not None
...
class Episode(object, metaclass=Database.DefaultMeta):
    ...
    def __lt__(self, other):
        if isinstance(other, Episode):
            return valid(self) and valid(other) and (self.series < other.series or
    ...
    def __eq__(self, other):
        if isinstance(other, Episode):
            return valid(self) and valid(other) and (self.series == other.series and
                    self.season == other.season and
                    self.number == other.number)
